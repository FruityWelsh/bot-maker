...
**Note**: DevX ADRs focus on the development workflow, toolchain, and automation, while Application ADRs focus on the core functionality and architecture of the ChatBot Operator. ADR-020 (Strategy First, Code Second) is the foundational principle that guides all development decisions in this project.